...
public class ArtistsTracksAdapter extends RecyclerView.Adapter<ArtistsTracksAdapter.ArtistsTrackHolder> {
    Context context;
    ...
    public ArtistsTracksAdapter(Context context, ArrayList<ArtistsTrackModel> list) {
    ...
    @NonNull
    @Override
    public ArtistsTrackHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        binding = ArtistsTracksItemsBinding.inflate(LayoutInflater.from(context), parent, false);
        return new ArtistsTrackHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull ArtistsTrackHolder holder, int position) {
...
//        holder.binding.trackTitleItems.setText(list.get(position).getName());
    ...
    public static class ArtistsTrackHolder extends RecyclerView.ViewHolder {
        ArtistsTracksItemsBinding binding;
        boolean isLiked = false;

        public ArtistsTrackHolder(@NonNull ArtistsTracksItemsBinding itemView) {
