...
public class FavoriteTrackAdapter extends RecyclerView.Adapter<FavoriteTrackAdapter.FavViewHolder> {
    Context context;
    ...
    public FavoriteTrackAdapter(Context context, ArrayList<ArtistsTrackModel> list) {
        this.context = context;
        this.list = list;
    }

    public FavoriteTrackAdapter(Context context, ArrayList<ArtistsTrackModel> list, OnItemClickListener listener) {
        this.context = context;
        this.list = list;
...
//        holder.binding.trackTitleItems.setText(list.get(position).getName());
    ...
    public static class FavViewHolder extends RecyclerView.ViewHolder {
        ...
        public FavViewHolder(@NonNull ArtistsTracksItemsBinding itemView) {
